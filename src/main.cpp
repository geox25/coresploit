...
static const char* _IMGUIGetClipboardText(void *) { return glfwGetClipboardString(window); }

static void _IMGUISetClipboardText(void *, const char *text) { glfwSetClipboardString(window, text); }
